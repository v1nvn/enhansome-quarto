...
* [Visual Studio Code/Positron](https://github.com/quarto-dev/quarto) ⭐ 560 | 🐛 374 | 🌐 TypeScript | 📅 2026-04-01 - Extension for [Visual Studio Code/Positron](https://code.visualstudio.com/) to work with Quarto.
* [Positron](https://positron.posit.co/) - A next-generation extensible, polyglot data science IDE built by Posit PBC (support via [the Visual Studio Code extension for Quarto](https://github.com/quarto-dev/quarto) ⭐ 560 | 🐛 374 | 🌐 TypeScript | 📅 2026-04-01).
...
* [Documentation website from Jupyter Notebook](https://github.com/aeturrell/skimpy) ⭐ 508 | 🐛 11 | 🌐 Python | 📅 2026-04-01 - Quarto used to generate a website from a Jupyter notebook containing Python module documentation.
...
* [Python for Data Analysis, 3E](https://github.com/wesm/pydata-book) ⭐ 24,449 | 🐛 26 | 🌐 Jupyter Notebook | 📅 2025-10-17 - "Python for Data Analysis" book third edition (see <https://wesmckinney.com/book/>).
...
* [R Packages, 2E](https://github.com/hadley/r-pkgs/) ⭐ 942 | 🐛 45 | 🌐 R | 📅 2026-04-01 - "R Packages" book second edition (see <https://r-pkgs.org/>).
* [mlr3book](https://github.com/mlr-org/mlr3book/tree/main/book/) ⭐ 278 | 🐛 17 | 🌐 TeX | 📅 2026-03-21 - Book on the [`mlr3`](https://mlr3.mlr-org.com/) packages ecosystem (see <https://mlr3book.mlr-org.com/>).
