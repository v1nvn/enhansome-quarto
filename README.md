...
* Filling a [suggestion issue](https://github.com/mcanouil/awesome-quarto/issues/new?assignees=mcanouil\&labels=\&template=suggestion.yml) ⭐ 2,069 | 🐛 1 | 📅 2026-02-26 (easier).
* Opening a [pull request](https://github.com/mcanouil/awesome-quarto/compare) ⭐ 2,069 | 🐛 1 | 📅 2026-02-26.
...
* [Literate Programming With Jupyter Notebooks and Quarto](https://www.rstudio.com/conference/2022/talks/literate-programming-quarto/) - Talk by Hamel Husain at RStudio::conf(2022) describing the integration between [Nbdev](https://github.com/fastai/nbdev) ⭐ 5,268 | 🐛 181 | 🌐 Jupyter Notebook | 📅 2026-02-26 and Quarto (materials: <https://github.com/fastai/nbdev-demo> ⭐ 4 | 🐛 0 | 📅 2022-06-09).
...
* [Visual Studio Code/Positron](https://github.com/quarto-dev/quarto) ⭐ 547 | 🐛 370 | 🌐 TypeScript | 📅 2026-02-18 - Extension for [Visual Studio Code/Positron](https://code.visualstudio.com/) to work with Quarto.
* [Positron](https://positron.posit.co/) - A next-generation extensible, polyglot data science IDE built by Posit PBC (support via [the Visual Studio Code extension for Quarto](https://github.com/quarto-dev/quarto) ⭐ 547 | 🐛 370 | 🌐 TypeScript | 📅 2026-02-18).
* [Neovim](https://github.com/quarto-dev/quarto-nvim) ⭐ 499 | 🐛 6 | 🌐 Lua | 📅 2026-01-29 - Tools for [Neovim](https://neovim.io/) to work with Quarto.
* [Emacs](https://github.com/quarto-dev/quarto-emacs) ⭐ 152 | 🐛 15 | 🌐 Emacs Lisp | 📅 2024-01-05 - Mode for [Emacs](https://www.gnu.org/software/emacs/) to work with Quarto.
...
* [altdoc](https://github.com/etiennebacher/altdoc) ⭐ 82 | 🐛 20 | 🌐 R | 📅 2026-03-02 - Alternative to pkgdown to document R packages.
...
* [Quarto Wizard](https://github.com/mcanouil/quarto-wizard) ⭐ 71 | 🐛 1 | 🌐 TypeScript | 📅 2026-03-06 - A Visual Studio Code extension that assists you in managing Quarto projects, such as installing and updating extensions.
* [Quarto Wingman](https://github.com/ntluong95/quarto-wingman) ⭐ 11 | 🐛 7 | 🌐 TypeScript | 📅 2026-02-27 - A Visual Studio Code extension that provides an interactive code cell configuration, improved Python syntax highlighting, intelligent token recognition, enhanced footnote display, and an inline code runner for R and Python, making it particularly useful for data exploration.
...
* [Quarto GitHub Actions](https://github.com/quarto-dev/quarto-actions) ⭐ 273 | 🐛 39 | 🌐 PowerShell | 📅 2026-03-09 - Official Quarto GitHub Actions to set up, render, and deploy Quarto projects via GitHub Actions.
* [Quarto Devcontainer Feature](https://github.com/rocker-org/devcontainer-features/tree/main/src/quarto-cli) ⭐ 67 | 🐛 18 | 🌐 Shell | 📅 2025-11-21 - Add Quarto CLI to your [Development Containers](https://containers.dev/) as a feature.
* [Quarto Extensions Updater](https://github.com/mcanouil/quarto-extensions-updater) ⭐ 12 | 🐛 1 | 🌐 TypeScript | 📅 2026-03-02 - A GitHub Action that automatically updates Quarto extensions in your repository, similar to how Dependabot manages dependencies.
...
* [The untold story of palmerpenguins](https://github.com/apreshill/palmerpenguins-useR-2022) ⭐ 32 | 🐛 0 | 🌐 HTML | 📅 2022-06-21 - [See slides](https://apreshill.github.io/palmerpenguins-useR-2022/).
...
* [Documentation website from Jupyter Notebook](https://github.com/aeturrell/skimpy) ⭐ 506 | 🐛 14 | 🌐 Python | 📅 2026-02-24 - Quarto used to generate a website from a Jupyter notebook containing Python module documentation.
* [quarto.org](https://github.com/quarto-dev/quarto-web) ⭐ 382 | 🐛 41 | 🌐 JavaScript | 📅 2026-03-06 - The Quarto documentation website.
* [Andrew Heiss's website](https://github.com/andrewheiss/ath-quarto) ⭐ 153 | 🐛 4 | 🌐 HTML | 📅 2026-03-06 - Website with custom EJS format, footer, 404 page, (S)CSS, and many more customisations.
* [R-Manuals](https://github.com/rstudio/r-manuals) ⭐ 97 | 🐛 1 | 🌐 R | 📅 2026-03-08 - R Manuals rewritten with Quarto.
...
* [AffCom Lab Website](https://github.com/jmgirard/affcomlab) ⭐ 18 | 🐛 0 | 🌐 HTML | 📅 2026-02-24 - A research lab Quarto Blog/website using custom listing pages for people and publications.
* [Bioconductor Community Blog](https://github.com/Bioconductor/biocblog) ⭐ 16 | 🐛 6 | 🌐 HTML | 📅 2026-02-12 - A Quarto Blog for the Bioconductor community.
...
* [Python for Data Analysis, 3E](https://github.com/wesm/pydata-book) ⭐ 24,370 | 🐛 26 | 🌐 Jupyter Notebook | 📅 2025-10-17 - "Python for Data Analysis" book third edition (see <https://wesmckinney.com/book/>).
* [R for Data Science, 2E](https://github.com/hadley/r4ds/) ⭐ 5,013 | 🐛 20 | 🌐 R | 📅 2026-02-27 - "R for Data Science" book second edition (see <https://r4ds.hadley.nz/>).
* [R Packages, 2E](https://github.com/hadley/r-pkgs/) ⭐ 936 | 🐛 45 | 🌐 R | 📅 2026-03-08 - "R Packages" book second edition (see <https://r-pkgs.org/>).
* [mlr3book](https://github.com/mlr-org/mlr3book/tree/main/book/) ⭐ 276 | 🐛 13 | 🌐 TeX | 📅 2026-03-03 - Book on the [`mlr3`](https://mlr3.mlr-org.com/) packages ecosystem (see <https://mlr3book.mlr-org.com/>).
...
Thanks goes to these [contributors](https://github.com/mcanouil/awesome-quarto/graphs/contributors) ⭐ 2,069 | 🐛 1 | 📅 2026-02-26!
