...
* Filling a [suggestion issue](https://github.com/mcanouil/awesome-quarto/issues/new?assignees=mcanouil\&labels=\&template=suggestion.yml) ⭐ 2,053 | 🐛 1 | 📅 2025-12-08 (easier).
* Opening a [pull request](https://github.com/mcanouil/awesome-quarto/compare) ⭐ 2,053 | 🐛 1 | 📅 2025-12-08.
...
* [Literate Programming With Jupyter Notebooks and Quarto](https://www.rstudio.com/conference/2022/talks/literate-programming-quarto/) - Talk by Hamel Husain at RStudio::conf(2022) describing the integration between [Nbdev](https://github.com/fastai/nbdev) ⭐ 5,251 | 🐛 177 | 🌐 Jupyter Notebook | 📅 2026-02-14 and Quarto (materials: <https://github.com/fastai/nbdev-demo> ⭐ 4 | 🐛 0 | 📅 2022-06-09).
...
* [Visual Studio Code/Positron](https://github.com/quarto-dev/quarto) ⭐ 537 | 🐛 366 | 🌐 TypeScript | 📅 2026-02-18 - Extension for [Visual Studio Code/Positron](https://code.visualstudio.com/) to work with Quarto.
* [Positron](https://positron.posit.co/) - A next-generation extensible, polyglot data science IDE built by Posit PBC (support via [the Visual Studio Code extension for Quarto](https://github.com/quarto-dev/quarto) ⭐ 537 | 🐛 366 | 🌐 TypeScript | 📅 2026-02-18).
...
* [Quarto Wizard](https://github.com/mcanouil/quarto-wizard) ⭐ 71 | 🐛 0 | 🌐 TypeScript | 📅 2026-02-18 - A Visual Studio Code extension that assists you in managing Quarto projects, such as installing and updating extensions.
...
* [quarto.org](https://github.com/quarto-dev/quarto-web) ⭐ 378 | 🐛 41 | 🌐 JavaScript | 📅 2026-02-18 - The Quarto documentation website.
...
* [NASCENT-PERU website](https://nascent-peru.github.io/) - A multi-lingual (English/Spanish) website for a scientific research project using the [babelquarto](https://github.com/ropensci-review-tools/babelquarto) ⭐ 59 | 🐛 10 | 🌐 R | 📅 2026-02-18 package.
...
* [Python for Data Analysis, 3E](https://github.com/wesm/pydata-book) ⭐ 24,309 | 🐛 26 | 🌐 Jupyter Notebook | 📅 2025-10-17 - "Python for Data Analysis" book third edition (see <https://wesmckinney.com/book/>).
...
* [R Packages, 2E](https://github.com/hadley/r-pkgs/) ⭐ 937 | 🐛 45 | 🌐 R | 📅 2026-02-18 - "R Packages" book second edition (see <https://r-pkgs.org/>).
* [mlr3book](https://github.com/mlr-org/mlr3book/tree/main/book/) ⭐ 275 | 🐛 13 | 🌐 TeX | 📅 2026-02-10 - Book on the [`mlr3`](https://mlr3.mlr-org.com/) packages ecosystem (see <https://mlr3book.mlr-org.com/>).
...
Thanks goes to these [contributors](https://github.com/mcanouil/awesome-quarto/graphs/contributors) ⭐ 2,053 | 🐛 1 | 📅 2025-12-08!
