...
* [Literate Programming With Jupyter Notebooks and Quarto](https://www.rstudio.com/conference/2022/talks/literate-programming-quarto/) - Talk by Hamel Husain at RStudio::conf(2022) describing the integration between [Nbdev](https://github.com/fastai/nbdev) ⭐ 5,279 | 🐛 181 | 🌐 Jupyter Notebook | 📅 2026-02-26 and Quarto (materials: <https://github.com/fastai/nbdev-demo> ⭐ 4 | 🐛 0 | 📅 2022-06-09).
...
* [Visual Studio Code/Positron](https://github.com/quarto-dev/quarto) ⭐ 555 | 🐛 372 | 🌐 TypeScript | 📅 2026-03-18 - Extension for [Visual Studio Code/Positron](https://code.visualstudio.com/) to work with Quarto.
* [Positron](https://positron.posit.co/) - A next-generation extensible, polyglot data science IDE built by Posit PBC (support via [the Visual Studio Code extension for Quarto](https://github.com/quarto-dev/quarto) ⭐ 555 | 🐛 372 | 🌐 TypeScript | 📅 2026-03-18).
* [Neovim](https://github.com/quarto-dev/quarto-nvim) ⭐ 503 | 🐛 6 | 🌐 Lua | 📅 2026-01-29 - Tools for [Neovim](https://neovim.io/) to work with Quarto.
...
* [Quarto GitHub Actions](https://github.com/quarto-dev/quarto-actions) ⭐ 275 | 🐛 39 | 🌐 PowerShell | 📅 2026-03-23 - Official Quarto GitHub Actions to set up, render, and deploy Quarto projects via GitHub Actions.
...
* [Documentation website from Jupyter Notebook](https://github.com/aeturrell/skimpy) ⭐ 507 | 🐛 6 | 🌐 Python | 📅 2026-03-25 - Quarto used to generate a website from a Jupyter notebook containing Python module documentation.
...
* [Python for Data Analysis, 3E](https://github.com/wesm/pydata-book) ⭐ 24,423 | 🐛 26 | 🌐 Jupyter Notebook | 📅 2025-10-17 - "Python for Data Analysis" book third edition (see <https://wesmckinney.com/book/>).
...
* [R Packages, 2E](https://github.com/hadley/r-pkgs/) ⭐ 940 | 🐛 45 | 🌐 R | 📅 2026-03-25 - "R Packages" book second edition (see <https://r-pkgs.org/>).
