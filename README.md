...
* Filling a [suggestion issue](https://github.com/mcanouil/awesome-quarto/issues/new?assignees=mcanouil\&labels=\&template=suggestion.yml) ⭐ 2,046 | 🐛 1 | 📅 2025-12-08 (easier).
* Opening a [pull request](https://github.com/mcanouil/awesome-quarto/compare) ⭐ 2,046 | 🐛 1 | 📅 2025-12-08.
...
* [Literate Programming With Jupyter Notebooks and Quarto](https://www.rstudio.com/conference/2022/talks/literate-programming-quarto/) - Talk by Hamel Husain at RStudio::conf(2022) describing the integration between [Nbdev](https://github.com/fastai/nbdev) ⭐ 5,253 | 🐛 184 | 🌐 Jupyter Notebook | 📅 2026-02-04 and Quarto (materials: <https://github.com/fastai/nbdev-demo> ⭐ 4 | 🐛 0 | 📅 2022-06-09).
...
* [Visual Studio Code/Positron](https://github.com/quarto-dev/quarto) ⭐ 534 | 🐛 362 | 🌐 TypeScript | 📅 2026-02-10 - Extension for [Visual Studio Code/Positron](https://code.visualstudio.com/) to work with Quarto.
* [Positron](https://positron.posit.co/) - A next-generation extensible, polyglot data science IDE built by Posit PBC (support via [the Visual Studio Code extension for Quarto](https://github.com/quarto-dev/quarto) ⭐ 534 | 🐛 362 | 🌐 TypeScript | 📅 2026-02-10).
...
* [quartodoc](https://github.com/machow/quartodoc) ⭐ 256 | 🐛 80 | 🌐 Python | 📅 2025-12-08 - A Python module that lets you quickly generate Python package API reference documentation using Markdown and Quarto.
...
* [Quarto Wizard](https://github.com/mcanouil/quarto-wizard) ⭐ 70 | 🐛 0 | 🌐 TypeScript | 📅 2026-02-08 - A Visual Studio Code extension that assists you in managing Quarto projects, such as installing and updating extensions.
* [Quarto Wingman](https://github.com/ntluong95/quarto-wingman) ⭐ 10 | 🐛 8 | 🌐 TypeScript | 📅 2025-11-21 - A Visual Studio Code extension that provides an interactive code cell configuration, improved Python syntax highlighting, intelligent token recognition, enhanced footnote display, and an inline code runner for R and Python, making it particularly useful for data exploration.
...
* [matrix BOT](https://github.com/rgomez90/matrix-bot) ⭐ 4 | 🐛 0 | 🌐 Python | 📅 2022-09-29 - A little bot for the [matrix-network](https://matrix.org/) that listens for some Quarto files and returns the PDF into the matrix channel.

## Continuous integration / Continuous deployment

* [Quarto GitHub Actions](https://github.com/quarto-dev/quarto-actions) ⭐ 270 | 🐛 39 | 🌐 PowerShell | 📅 2026-02-09 - Official Quarto GitHub Actions to set up, render, and deploy Quarto projects via GitHub Actions.
...
* [quarto.org](https://github.com/quarto-dev/quarto-web) ⭐ 377 | 🐛 37 | 🌐 JavaScript | 📅 2026-02-10 - The Quarto documentation website.
...
* [Bioconductor Community Blog](https://github.com/Bioconductor/biocblog) ⭐ 17 | 🐛 5 | 🌐 HTML | 📅 2025-12-13 - A Quarto Blog for the Bioconductor community.
...
* [Python for Data Analysis, 3E](https://github.com/wesm/pydata-book) ⭐ 24,290 | 🐛 26 | 🌐 Jupyter Notebook | 📅 2025-10-17 - "Python for Data Analysis" book third edition (see <https://wesmckinney.com/book/>).
...
* [R Packages, 2E](https://github.com/hadley/r-pkgs/) ⭐ 937 | 🐛 45 | 🌐 R | 📅 2026-02-10 - "R Packages" book second edition (see <https://r-pkgs.org/>).
...
* [Network Science: Models, Mathematics, and Computation](https://github.com/network-science-notes/network-science-notes.github.io) ⭐ 2 | 🐛 2 | 🌐 TeX | 📅 2025-05-25 - Undergraduate lecture notes in network science featuring custom CSS and companion live-coding notebooks via Google Colab. (see <https://network-science-notes.github.io/>).
...
Thanks goes to these [contributors](https://github.com/mcanouil/awesome-quarto/graphs/contributors) ⭐ 2,046 | 🐛 1 | 📅 2025-12-08!
