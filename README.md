...
* Filling a [suggestion issue](https://github.com/mcanouil/awesome-quarto/issues/new?assignees=mcanouil\&labels=\&template=suggestion.yml) ⭐ 2,072 | 🐛 2 | 📅 2026-02-26 (easier).
* Opening a [pull request](https://github.com/mcanouil/awesome-quarto/compare) ⭐ 2,072 | 🐛 2 | 📅 2026-02-26.
...
* [Visual Studio Code/Positron](https://github.com/quarto-dev/quarto) ⭐ 548 | 🐛 373 | 🌐 TypeScript | 📅 2026-02-18 - Extension for [Visual Studio Code/Positron](https://code.visualstudio.com/) to work with Quarto.
* [Positron](https://positron.posit.co/) - A next-generation extensible, polyglot data science IDE built by Posit PBC (support via [the Visual Studio Code extension for Quarto](https://github.com/quarto-dev/quarto) ⭐ 548 | 🐛 373 | 🌐 TypeScript | 📅 2026-02-18).
...
* [Quarto Devcontainer Feature](https://github.com/rocker-org/devcontainer-features/tree/main/src/quarto-cli) ⭐ 68 | 🐛 19 | 🌐 Shell | 📅 2025-11-21 - Add Quarto CLI to your [Development Containers](https://containers.dev/) as a feature.
...
* [Documentation website from Jupyter Notebook](https://github.com/aeturrell/skimpy) ⭐ 506 | 🐛 6 | 🌐 Python | 📅 2026-03-11 - Quarto used to generate a website from a Jupyter notebook containing Python module documentation.
* [quarto.org](https://github.com/quarto-dev/quarto-web) ⭐ 383 | 🐛 39 | 🌐 JavaScript | 📅 2026-03-11 - The Quarto documentation website.
...
* [Python for Data Analysis, 3E](https://github.com/wesm/pydata-book) ⭐ 24,377 | 🐛 26 | 🌐 Jupyter Notebook | 📅 2025-10-17 - "Python for Data Analysis" book third edition (see <https://wesmckinney.com/book/>).
* [R for Data Science, 2E](https://github.com/hadley/r4ds/) ⭐ 5,016 | 🐛 20 | 🌐 R | 📅 2026-02-27 - "R for Data Science" book second edition (see <https://r4ds.hadley.nz/>).
* [R Packages, 2E](https://github.com/hadley/r-pkgs/) ⭐ 936 | 🐛 45 | 🌐 R | 📅 2026-03-11 - "R Packages" book second edition (see <https://r-pkgs.org/>).
* [mlr3book](https://github.com/mlr-org/mlr3book/tree/main/book/) ⭐ 276 | 🐛 14 | 🌐 TeX | 📅 2026-03-11 - Book on the [`mlr3`](https://mlr3.mlr-org.com/) packages ecosystem (see <https://mlr3book.mlr-org.com/>).
...
Thanks goes to these [contributors](https://github.com/mcanouil/awesome-quarto/graphs/contributors) ⭐ 2,072 | 🐛 2 | 📅 2026-02-26!
