...
* [Visual Studio Code/Positron](https://github.com/quarto-dev/quarto) ⭐ 560 | 🐛 375 | 🌐 TypeScript | 📅 2026-03-31 - Extension for [Visual Studio Code/Positron](https://code.visualstudio.com/) to work with Quarto.
* [Positron](https://positron.posit.co/) - A next-generation extensible, polyglot data science IDE built by Posit PBC (support via [the Visual Studio Code extension for Quarto](https://github.com/quarto-dev/quarto) ⭐ 560 | 🐛 375 | 🌐 TypeScript | 📅 2026-03-31).
...
* [Python for Data Analysis, 3E](https://github.com/wesm/pydata-book) ⭐ 24,443 | 🐛 26 | 🌐 Jupyter Notebook | 📅 2025-10-17 - "Python for Data Analysis" book third edition (see <https://wesmckinney.com/book/>).
...
* [R Packages, 2E](https://github.com/hadley/r-pkgs/) ⭐ 941 | 🐛 45 | 🌐 R | 📅 2026-03-31 - "R Packages" book second edition (see <https://r-pkgs.org/>).
