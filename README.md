...
* [Neovim](https://github.com/quarto-dev/quarto-nvim) ⭐ 502 | 🐛 6 | 🌐 Lua | 📅 2026-01-29 - Tools for [Neovim](https://neovim.io/) to work with Quarto.
...
* [Documentation website from Jupyter Notebook](https://github.com/aeturrell/skimpy) ⭐ 507 | 🐛 8 | 🌐 Python | 📅 2026-03-24 - Quarto used to generate a website from a Jupyter notebook containing Python module documentation.
* [quarto.org](https://github.com/quarto-dev/quarto-web) ⭐ 386 | 🐛 36 | 🌐 JavaScript | 📅 2026-03-24 - The Quarto documentation website.
...
* [Python for Data Analysis, 3E](https://github.com/wesm/pydata-book) ⭐ 24,416 | 🐛 26 | 🌐 Jupyter Notebook | 📅 2025-10-17 - "Python for Data Analysis" book third edition (see <https://wesmckinney.com/book/>).
...
* [R Packages, 2E](https://github.com/hadley/r-pkgs/) ⭐ 939 | 🐛 45 | 🌐 R | 📅 2026-03-24 - "R Packages" book second edition (see <https://r-pkgs.org/>).
