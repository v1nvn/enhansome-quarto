...
* Filling a [suggestion issue](https://github.com/mcanouil/awesome-quarto/issues/new?assignees=mcanouil\&labels=\&template=suggestion.yml) ⭐ 2,048 | 🐛 1 | 📅 2025-12-08 (easier).
* Opening a [pull request](https://github.com/mcanouil/awesome-quarto/compare) ⭐ 2,048 | 🐛 1 | 📅 2025-12-08.
...
* [Visual Studio Code/Positron](https://github.com/quarto-dev/quarto) ⭐ 535 | 🐛 365 | 🌐 TypeScript | 📅 2026-02-11 - Extension for [Visual Studio Code/Positron](https://code.visualstudio.com/) to work with Quarto.
* [Positron](https://positron.posit.co/) - A next-generation extensible, polyglot data science IDE built by Posit PBC (support via [the Visual Studio Code extension for Quarto](https://github.com/quarto-dev/quarto) ⭐ 535 | 🐛 365 | 🌐 TypeScript | 📅 2026-02-11).
* [Neovim](https://github.com/quarto-dev/quarto-nvim) ⭐ 495 | 🐛 6 | 🌐 Lua | 📅 2026-01-29 - Tools for [Neovim](https://neovim.io/) to work with Quarto.
...
* [Quarto Wizard](https://github.com/mcanouil/quarto-wizard) ⭐ 71 | 🐛 0 | 🌐 TypeScript | 📅 2026-02-08 - A Visual Studio Code extension that assists you in managing Quarto projects, such as installing and updating extensions.
...
* [quarto.org](https://github.com/quarto-dev/quarto-web) ⭐ 377 | 🐛 37 | 🌐 JavaScript | 📅 2026-02-11 - The Quarto documentation website.
...
* [Python for Data Analysis, 3E](https://github.com/wesm/pydata-book) ⭐ 24,291 | 🐛 26 | 🌐 Jupyter Notebook | 📅 2025-10-17 - "Python for Data Analysis" book third edition (see <https://wesmckinney.com/book/>).
...
* [R Packages, 2E](https://github.com/hadley/r-pkgs/) ⭐ 937 | 🐛 45 | 🌐 R | 📅 2026-02-11 - "R Packages" book second edition (see <https://r-pkgs.org/>).
...
Thanks goes to these [contributors](https://github.com/mcanouil/awesome-quarto/graphs/contributors) ⭐ 2,048 | 🐛 1 | 📅 2025-12-08!
